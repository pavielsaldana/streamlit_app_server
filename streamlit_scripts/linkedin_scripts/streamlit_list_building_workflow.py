...
if option != "Select Client ICP":
    ...
    if option == "Onfleet (DSP)":
        ...
        sales_navigator_query_1 = st.text_input(label="Sales Navigator query 1", value="")
        sales_navigator_query_2 = st.text_input(label="Sales Navigator query 2", value="")
        sales_navigator_query_3 = st.text_input(label="Sales Navigator query 3", value="")
